...
public class LITColpoRiccoWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(LITColpoRiccoWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/LITColpoRiccoWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/LITColpoRiccoWLAIW/InitOutcome.xml").getDocumentElement();
